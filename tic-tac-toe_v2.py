    ...
    def ai():
        ...
        if count == 0:
            ...
            if (wh1.count("X") == 2) and len(vh1) == 1:
                ...
                if f == 1 and count == 4:
                    if (('1' not in pi) and ('8' not in pi)) or \
                            (('9' not in pi) and ('4' not in pi)):
                        if board[6] == '-':
                            pos = 7
                    elif (('6' not in pi) and ('1' not in pi)) or \
                            (('9' not in pi) and ('2' not in pi)):
                        if board[2] == '-':
                            pos = 3
                    elif (('7' not in pi) and ('2' not in pi)) or \
                            (('3' not in pi) and ('4' not in pi)):
                        if board[0] == '-':
                            pos = 1
                    elif (('7' not in pi) and ('6' not in pi)) or \
                            (('3' not in pi) and ('8' not in pi)):
                        if board[8] == '-':
                            pos = 9
                    else:
                        if board[4] == '-':
                    ...
                    if (otro[0] == 1 and otro[1] == 8) or \
                            (otro[0] == 8 and otro[1] == 1):
                        pos = 7
                    elif (otro[0] == 1 and otro[1] == 6) or \
                            (otro[0] == 6 and otro[1] == 1):
                        pos = 3
                    elif (otro[0] == 7 and otro[1] == 2) or \
                            (otro[0] == 2 and otro[1] == 7):
                        pos = 1
                    elif (otro[0] == 7 and otro[1] == 6) or \
                            (otro[0] == 6 and otro[1] == 7):
                        pos = 9
                    elif (otro[0] == 9 and otro[1] == 2) or \
                            (otro[0] == 2 and otro[1] == 9):
                        pos = 3
                    elif (otro[0] == 9 and otro[1] == 4) or \
                            (otro[0] == 4 and otro[1] == 9):
                        pos = 7
                    elif (otro[0] == 3 and otro[1] == 4) or \
                            (otro[0] == 4 and otro[1] == 3):
                        pos = 1
                    elif (otro[0] == 3 and otro[1] == 8) or \
                            (otro[0] == 8 and otro[1] == 3):
                        pos = 9
